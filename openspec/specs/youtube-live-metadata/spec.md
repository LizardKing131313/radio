...
Defines the optional YouTube Live metadata synchronization used by the radio runtime. It does not create an RTMP push
flow or manage YouTube stream keys.
