...
# GOVNOVOZ — final pass (15s, 2560x1440 @ 60fps, WebM/VP9)
# основано на твоём эталонном превью
...
[v2][3:v]overlay=enable='between(t,9,11)':x='-300+((t-9)*250)':y=820[v3];\
[v3]noise=alls=12:allf=t[vout]" \
